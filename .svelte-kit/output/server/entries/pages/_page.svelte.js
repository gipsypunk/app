...
const Contacts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<section id="contacts" class="pt-24 pb-24 relative overflow-hidden" data-svelte-h="svelte-sasih3"><div class="container max-w-7xl mx-auto p-6"><div class="flex flex-col md:flex-row items-center"><div class="md:w-2/4"><h1 class="text-blue-d font-display text-4xl font-black uppercase text-center">Contact us if you <br>still have <span class="text-blue-b">questions</span>?</h1></div> <div class="md:w-2/4 mt-8"><div class="flex float-right pt-4 pb-4"><a href="mailto:info@yeswater.la" class="px-6 py-4 bg-blue-b shadow-2xl text-white text-4xl rounded-message md:text-6xl md:px-12">info@yeswater.la</a></div> <div class="flex float-left pt-4 pb-4"><a href="tel:+14244386801" class="px-6 py-4 bg-blue-d shadow-2xl text-white text-4xl rounded-message_2 md:text-6xl md:px-12">424.438.6801</a></div></div></div></div></section>`;
});
...
const Modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<dialog id="my_modal_3" class="modal" data-svelte-h="svelte-ypbap7"><div class="modal-box"><form method="dialog"><button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button></form> <div class="flex flex-col items-center"><h1 class="pt-2 text-xl text-blue-b font-semibold">Want to install a water filter?</h1> <h3 class="pt-2 text-base text-blue-d text-center">Just fill out the form and we&#39;ll get in touch <br> to you as soon as possible.</h3></div> <form action="send.php" class="flex flex-col"><input type="text" name="name" placeholder="Your name" class="mt-4 p-2 rounded-lg border border-slate-200 focus:outline-none focus:border-blue-b" required> <input type="text" name="email" placeholder="Your email" class="mt-4 p-2 rounded-lg border border-slate-200 focus:outline-none focus:border-blue-b" required> <input type="tel" name="phone" placeholder="Your phone number" class="mt-4 p-2 rounded-lg border border-slate-200 focus:outline-none focus:border-blue-b" required> <div class="p-8 flex flex-row justify-between"><input type="submit" value="Send" class="btn m-2 bg-blue-b text-base border-0 text-white hover:bg-white hover:text-blue-b hover:border hover:border-blue-b w-36 rounded-[50px] shadow-3xl"> <div class="flex flex-col items-center"><a href="tel:+14244386801" class="text-blue-b">424.438.6801</a> <a href="mailto:info@yeswater.la" class="text-blue-b">info@yeswater.la</a></div></div></form></div> <form method="dialog" class="modal-backdrop"><button>close</button></form></dialog>`;
});
const LandingPage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main>${validate_component(Hero, "Hero").$$render($$result, {}, {}, {})} ${validate_component(Features, "Features").$$render($$result, {}, {}, {})} ${validate_component(Products, "Products").$$render($$result, {}, {}, {})} ${validate_component(Service, "Service").$$render($$result, {}, {}, {})} ${validate_component(About, "About").$$render($$result, {}, {}, {})} ${validate_component(Counter, "Counter").$$render($$result, {}, {}, {})} ${validate_component(Testimonials, "Testimonials").$$render($$result, {}, {}, {})} ${validate_component(Contacts, "Contacts").$$render($$result, {}, {}, {})}</main> ${validate_component(Modal, "Modal").$$render($$result, {}, {}, {})} ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}`;
});
