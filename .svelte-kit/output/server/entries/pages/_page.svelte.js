...
const p2 = "/_app/immutable/assets/02.d9cd0507.jpg";
const p3 = "/_app/immutable/assets/03.49129384.jpg";
const p4 = "/_app/immutable/assets/04.c525dac1.jpg";
const p5 = "/_app/immutable/assets/05.5613fd36.png";
const p6 = "/_app/immutable/assets/06.f791ae95.jpg";
...
const Contacts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<section id="contacts" class="pt-24 pb-24 relative overflow-hidden" data-svelte-h="svelte-13t26oe"><div class="container max-w-7xl mx-auto p-6"><div class="flex flex-col md:flex-row items-center"><div class="md:w-2/4"><h1 class="text-blue-d font-display text-4xl font-black uppercase text-center">Contact us if you <br>still have <span class="text-blue-b">questions</span>?</h1></div> <div class="md:w-2/4 mt-8"><div class="flex float-right pt-4 pb-4"><a href="" class="px-6 py-4 bg-blue-b text-white text-4xl rounded-message md:text-8xl md:px-12">info@yeswater.la</a></div> <div class="flex float-left pt-4 pb-4"><a href="tel:+14244386801" class="px-6 py-4 bg-blue-d text-white text-4xl rounded-message_2 md:text-8xl md:px-12">424.438.6801</a></div></div></div></div></section>`;
});
const logo = "/_app/immutable/assets/logo_l.7fe7da2a.png";
const qr = "/_app/immutable/assets/qr.be0b5abf.png";
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<footer id="footer" data-svelte-h="svelte-w3l7fd"><svg class="fill-blue-d mb-[-4px]" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1440 184"><path class="f-bg-wave" d="M1285.4,81.2c-34,12.5-98.3,33.1-186.9,39.8c-230.8,17.6-274.8-85-472.8-71.3
		c-182,12.6-219.4,104.5-345.3,65.2C237.9,101.6,177,70.7,91.6,81.2c-31.7,4-62.6,13-91.6,26.6V184h1440V0
		C1392.2,33.7,1340.3,61,1285.4,81.2z"></path></svg> <div class="bg-blue-d"><div class="container max-w-7xl mx-auto p-6"><div class="flex flex-col justify-between md:flex-row"><div class="p-4"><h3 class="text-2xl font-semibold text-white"><strong><span class="text-blue-b text-3xl">|</span></strong> Menu</h3> <ul class="text-white"><li class="pt-2"><a href="/" class="menu-link hover:text-blue-b transition-colors">Home</a></li> <li class="pt-2"><a href="#products" class="menu-link hover:text-blue-b transition-colors">Producs</a></li> <li class="pt-2"><a href="#service" class="menu-link hover:text-blue-b transition-colors">Service</a></li> <li class="pt-2"><a href="#about" class="menu-link hover:text-blue-b transition-colors">About us</a></li> <li class="pt-2"><a href="#contacts" class="menu-link hover:text-blue-b transition-colors">Contact us</a></li></ul></div> <div class="p-4"><div><h3 class="text-2xl font-semibold text-white"><strong><span class="text-blue-b text-3xl">|</span></strong> Contact us</h3> <div class="text-white"><p class="pt-2">Wilshire Blvd #1600 Los Angeles, CA 90024</p> <p class="pt-2">Call us: 
...
const LandingPage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main>${validate_component(Hero, "Hero").$$render($$result, {}, {}, {})} ${validate_component(Features, "Features").$$render($$result, {}, {}, {})} ${validate_component(Products, "Products").$$render($$result, {}, {}, {})} ${validate_component(Service, "Service").$$render($$result, {}, {}, {})} ${validate_component(About, "About").$$render($$result, {}, {}, {})} ${validate_component(Testimonials, "Testimonials").$$render($$result, {}, {}, {})} ${validate_component(Counter, "Counter").$$render($$result, {}, {}, {})} ${validate_component(Contacts, "Contacts").$$render($$result, {}, {}, {})}</main> ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}`;
});
