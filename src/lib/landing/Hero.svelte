...
<section id="hero" class=" pb-24 relative overflow-hidden">
    <div class="bg-blue-a">
        <div class="container max-w-7xl mx-auto p-6">
            <div  class="pt-[100px] flex flex-col items-center  md:flex-row-reverse">
                ...
                <div class="pt-20 flex flex-col md:w-2/4 md:justify-end md:pr-8">
