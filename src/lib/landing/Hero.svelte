...
<section id="hero">
    <div class="bg-blue-a">
        <div class="container max-w-7xl mx-auto p-6">
            <div  class="flex flex-col items-center  md:flex-row-reverse">
                <div class="flex flex-col items-center md:w-2/4 md:justify-start animate-bounce2">
                    <img src="{glass}" alt="" class="w-[200px] h-[360px] md:w-[320px] md:h-[640px] object-cover">
                </div>
                <div class="flex flex-col md:w-2/4 md:justify-end md:pr-8">
                    ...
                    <div class="flex flex-row pt-4">
                        ...
                        <a href="#features" class='btn  m-2 bg-white  text-base text-blue-b font-semibold hover:bg-blue-b hover:text-white hover:border-none w-36 rounded-[50px] shadow-3xl'>Order now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class="fill-blue-a rotate-180 mt-[-10px]">
