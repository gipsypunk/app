...
const Testimonials = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<section id="testimonials" class="pt-24 pb-24 relative overflow-hidden "><div class="bg-[linear-gradient(180deg,#FFFFFF_0%,#F3FAFF_100%)]"><div class="container max-w-7xl mx-auto p-6"><div class="flex flex-col max-h-max mr-auto ml-auto relative"><div class="flex flex-col items-center" data-svelte-h="svelte-1s25rlg"><h1 class="text-4xl font-display uppercase font-black text-blue-d text-center">What our <span class="text-blue-b">clients say</span></h1> <h3 class="text-xl text-blue-d">Testomonials</h3></div> <div class="">${validate_component(Feedback, "Feedback").$$render(
    ...
    {},
    {}
  )}</div></div></div></div> <div data-svelte-h="svelte-tbh040"><img${add_attribute("src", bg3, 0)} alt="" class="bg-[#F3FAFF]"></div></section>                             `;
});
