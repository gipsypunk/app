...
<section id="section">
    ...
    <div class="bg-blue-a">
        <div class="container max-w-7xl mx-auto p-6">
            <div class="flex flex-col items-center text-justify">
                <h1 class="text-4xl font-display uppercase font-black text-blue-d"><span class="text-blue-b">Our</span> story</h1>
            ...
            <div class="pt-8 flex flex-col items-center text-justify">
                <h1 class="text-4xl font-display uppercase font-black text-blue-d">How we <span class="text-blue-b">work</span></h1>
                <div class="pt-8 flex flex-wrap justify-center">
                    <div class="p-2">
                        ...
                        <h3 class="text-blue-d font-display uppercase text-sm text-center pt-2 md:text-base">Make your order <br>on our site</h3>
                    </div>
                    ...
                    <div class="p-2">
                        ...
                        <h3 class="text-blue-d font-display uppercase text-sm text-center pt-2 md:text-base">We confirm <br>your order</h3>
                    </div>
                    ...
                    <div class="p-2">
                        ...
                        <h3 class="text-blue-d font-display uppercase text-sm text-center pt-2 md:text-base">Our engineer will come <br> to you super fast</h3>
                    </div>
                    ...
                    <div class="p-2">
                        ...
                        <h3 class="text-blue-d font-display uppercase text-sm text-center pt-2 md:text-base">Installation takes <br> from 30-60 minutes</h3>
                    </div>
                    ...
                    <div class="p-2">
                        ...
                        <h3 class="text-blue-d font-display uppercase text-sm text-center pt-2 md:text-base">Done  now you can<br>enjoy clean water <br>every day</h3>
                    </div>
                </div>
            </div>          
        </div>
    ...
    <div>
        <img src="{bg2}" alt="" class='bg-blue-a'>
    </div>
</section>
